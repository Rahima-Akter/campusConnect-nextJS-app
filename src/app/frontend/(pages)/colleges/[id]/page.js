  ...
  const reviews = [
    {
      ...
      date: "May 15, 2023",
      rating: 5,
      avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuCI575Np384b0ASIILOdXrAKtpA80Nm68bU5rilz5T2CAeZkfzhiuH4zFkK0uYeWRmNzw0bFErfH1sdKfYV_ADNZCxEJZDEfDtLQnTcze7-COBDlk6LMbAjMZkE-rNRzZsPNXxqHHqjGm4wcH_7C9p63ESo3l5xWR4vJuhm1L6uUaB1PmgGmsNxHhSG9Ih_wC0baHhP7TWOLRngG3h3VfXO30zWBDClm_jvx5n8uVc1u8u8WURXqh_5lbsV_cdgc_pRcRs37_tAI3g",
      comment: "My experience at University of Metropolitan has been nothing short of amazing. The faculty are incredibly supportive, and the campus environment is vibrant and inclusive."
    },
    {
      name: "Ethan Bennett",
      date: "June 20, 2023",
      rating: 4,
      avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuBI7F8h_uYHmx6UwgLgFMed7964IFQudn6NkLrrArNO1viB2_-3OmvykPM_79dl7kqWrU4ZTtbvhrfYOCKzjurdxxZdJA8EseE2bH5Nag60ABAH0VoB9XX4Kiz5_-uUdelU4KBxAePSus_meVrAQCasv0sJSjh2oxswuVmJjG8e24KCQwxGSj42Aeo6o8ImqM6KddrLzLz2W3JjO5xu8YVfbVwU4F1RDqidE3sP0BSIcgX1RgHjlA01pyy3yMErqNUYBDyYccUUDWQ",
      comment: "University of Metropolitan offers a great balance between academics and social life. The courses are challenging but rewarding, and there are plenty of opportunities to get involved."
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 mb-6">
          <div className="flex space-x-8">
            {['Overview', 'Admissions', 'Events', 'Research', 'Sports'].map((tab, i) => (
              <button
                key={tab}
                className={`pb-3 px-1 border-b-2 ${i === 0 ? 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            University of Metropolitan is a vibrant academic community committed to fostering intellectual growth and personal development. With a rich history and a forward-thinking approach, we offer a wide range of undergraduate and graduate programs designed to prepare students for success in a rapidly changing world.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {campusImages.map((img, i) => (
              <div key={i} className="aspect-square bg-cover bg-center rounded-lg" style={{ backgroundImage: `url('${img}')` }} />
            ))}
          </div>
        </section>
...
function StarIcon({ filled }) {
  return (
    <svg 
      ...
      stroke="currentColor"
      className={filled ? "text-yellow-400" : "text-gray-300 dark:text-gray-500"}
    >
      <path 
