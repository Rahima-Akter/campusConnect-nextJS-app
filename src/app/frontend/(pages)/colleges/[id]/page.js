      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            to fostering intellectual growth and personal development. With a
            rich history and a forward-thinking approach, we offer a wide range
            of undergraduate and graduate programs designed to prepare students
